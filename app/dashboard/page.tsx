      ...
      <nav className="border-b border-orbit-border bg-orbit-surface/80 backdrop-blur-sm sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-orbit-tertiary text-sm">/ Projects</span>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-orbit-secondary text-sm mt-1">
            Select a client to run or view their organic opportunity brief.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <button
              onClick={() => setShowNewModal(true)}
              className="orbit-card h-40 flex flex-col items-center justify-center gap-2 text-orbit-secondary hover:text-orbit-accent hover:border-orbit-accent-dim transition-all cursor-pointer group"
            >
...
function EmptyState({ onNew }: { onNew: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center py-24 gap-4">
      ...
      <button
        onClick={onNew}
        className="bg-orbit-accent hover:bg-orbit-accent-light text-white text-sm font-medium px-6 py-2.5 rounded-lg transition-colors"
      >
        Add First Client
      </button>
    </div>
