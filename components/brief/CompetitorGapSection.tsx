...
export default function CompetitorGapSection({ analysis }: Props) {
  ...
  // Build player rows: client first, then competitors
  const players: PlayerRow[] = [
    { domain: clientName, traffic: clientTraffic, isClient: true },
    ...
    <div className="orbit-card p-6 flex flex-col gap-5">
      ...
      {totalMonthly > 0 && (
        <div>
          ...
          <div
            ...
            style={{ gridTemplateColumns: '1fr 88px 72px 64px' }}
          >
            <span className="text-orbit-tertiary text-[10px] font-medium uppercase tracking-wider">Player</span>
            <span className="text-orbit-tertiary text-[10px] font-medium uppercase tracking-wider text-right">Traffic/mo</span>
            <span className="text-orbit-tertiary text-[10px] font-medium uppercase tracking-wider text-right">% of market</span>
            <span className="text-orbit-tertiary text-[10px] font-medium uppercase tracking-wider text-right">Rank</span>
          </div>
          ...
          {players.map((p, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-orbit-tertiary text-xs text-right">
                  #{i + 1}
                </span>
              </div>
            );
          ...
          >
            ...
            <span className="text-orbit-tertiary text-xs text-right">—</span>
          </div>
      ...
      <div className="grid grid-cols-3 gap-2.5">
        ...
        <StatCard
          ...
          source={`${fmtNum(topCompTraffic)} organic visits/mo`}
          valueColor="#F59E0B"
          smallValue
        />
        <StatCard
