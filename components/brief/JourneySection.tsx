...
// route runs the SAME math server-side (Const II.7). Imported back and re-exported
// below, so every existing consumer of this module keeps working unchanged.
import {
  detectIntent, isBranded, tokensOf, buildProcWordsByCat, namesSolutionFor,
  deriveProblemVocab, deterministicProblemTheme, buildRelevanceTokens, isClientRelevant,
  classifyJourneyType, buildJourneyClassifier as _buildJourneyClassifier,
  TRANSACTIONAL_SIGNALS, COMMERCIAL_SIGNALS, INFORMATIONAL_SIGNALS,
  type JourneyClass as _JourneyClass,
} from '@/lib/journey/classifier';
import {
  SHARED_BUCKET as _SHARED_BUCKET, segWords, buildSegTokens as _buildSegTokens,
  bucketForText as _bucketForText, buildCanonTopicSegmentMap as _buildCanonTopicSegmentMap,
  canonTopicState as _canonTopicState,
} from '@/lib/journey/segments';
export type JourneyClass = _JourneyClass;
export const buildJourneyClassifier = _buildJourneyClassifier;
export const SHARED_BUCKET = _SHARED_BUCKET;
export const buildSegTokens = _buildSegTokens;
export const bucketForText = _bucketForText;
export const buildCanonTopicSegmentMap = _buildCanonTopicSegmentMap;
const canonTopicState = _canonTopicState;
